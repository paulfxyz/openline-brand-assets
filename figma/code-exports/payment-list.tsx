import svgPaths from "./svg-pf1lb5n4pe";
import newSvgPaths from "./svg-zhuday4tgv";
import amexSvgPaths from "./svg-424ze54vrz";
...
function Img2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
        <g id="Img">
          <path d={amexSvgPaths.p265aae00} fill="var(--fill-0, black)" id="Vector" opacity="0.07" />
          <path d={amexSvgPaths.p1e9ee00} fill="var(--fill-0, white)" id="Vector_2" />
          <g id="Img_2">
            <path d={amexSvgPaths.pd308d80} fill="var(--fill-0, #005B9A)" id="Vector_3" />
            <path d={amexSvgPaths.p2d4faf80} fill="var(--fill-0, #E9292D)" id="Vector_4" />
            <path d={amexSvgPaths.pe0d6e80} fill="var(--fill-0, #0E73B9)" id="Vector_5" />
            <path d={amexSvgPaths.pa5181f0} fill="var(--fill-0, #059DA4)" id="Vector_6" />
            <path d={amexSvgPaths.p30ca0f00} fill="var(--fill-0, white)" id="Vector_7" />
          </g>
          <g id="Group 3">
            <path d={amexSvgPaths.p23661d00} fill="var(--fill-0, #006FCF)" id="Vector_8" />
            <path d={amexSvgPaths.p26131440} fill="var(--fill-0, white)" id="Vector_9" />
            <path d={amexSvgPaths.p34830c00} fill="var(--fill-0, #006FCF)" id="Vector_10" />
            <path d={amexSvgPaths.p35366e00} fill="var(--fill-0, #006FCF)" id="Vector_11" />
            <path d={amexSvgPaths.pe4d3600} fill="var(--fill-0, white)" id="Vector_12" />
            <path d={amexSvgPaths.p332fa330} fill="var(--fill-0, #006FCF)" id="Vector_13" />
            <path d={amexSvgPaths.p264d4280} fill="var(--fill-0, #006FCF)" id="Vector_14" />
          </g>
        </g>
      </svg>
    </div>
...
function Img3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
        <g id="Img">
          <path d={newSvgPaths.p265aae00} fill="var(--fill-0, black)" id="Vector" opacity="0.07" />
          <path d={newSvgPaths.p1e9ee00} fill="var(--fill-0, white)" id="Vector_2" />
          <g id="Img_2">
            <path d={newSvgPaths.pd308d80} fill="var(--fill-0, #005B9A)" id="Vector_3" />
            <path d={newSvgPaths.p2d4faf80} fill="var(--fill-0, #E9292D)" id="Vector_4" />
            <path d={newSvgPaths.pe0d6e80} fill="var(--fill-0, #0E73B9)" id="Vector_5" />
            <path d={newSvgPaths.pa5181f0} fill="var(--fill-0, #059DA4)" id="Vector_6" />
            <path d={newSvgPaths.p30ca0f00} fill="var(--fill-0, white)" id="Vector_7" />
          </g>
        </g>
      </svg>
    </div>
  ...
  return (
    <div className="absolute inset-[27.6%_67.09%_34.01%_13.18%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.49635 9.2135">
        <g id="Group">
          <path d={newSvgPaths.p255b0000} fill="var(--fill-0, black)" id="Vector" />
          <path d={newSvgPaths.pc1e4e40} fill="var(--fill-0, black)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="absolute inset-[30.3%_13.42%_24.69%_39.36%]" data-name="Group">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 17.9439 10.8029">
        <g id="Group">
          <path d={newSvgPaths.p1b020600} fill="var(--fill-0, black)" id="Vector" />
          <path d={newSvgPaths.p1b08bb00} fill="var(--fill-0, black)" id="Vector_2" />
          <path d={newSvgPaths.p214c4400} fill="var(--fill-0, black)" id="Vector_3" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <div className="absolute inset-[0_0.67%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 37.4888 23.9998">
          <path d={newSvgPaths.p2deae000} fill="var(--fill-0, #E4E4E4)" id="Vector" />
        </svg>
      </div>
      <div className="absolute inset-[3.33%_2.78%]" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35.8889 22.4001">
          <path d={newSvgPaths.p173addc0} fill="var(--fill-0, white)" id="Vector" />
        </svg>
      </div>
      <Group4 />
    </div>
    ...
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
        <g id="Img">
          ...
          <path d={svgPaths.p8dd84c0} fill="url(#paint0_linear_4004_151)" id="Vector_4" />
          <path d={svgPaths.p8dd84c0} fill="url(#paint1_linear_4004_151)" id="Vector_5" opacity="0.65" />
        ...
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_4004_151" x1="21.6565" x2="19.6315" y1="12.275" y2="9.10405">
          ...
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_4004_151" x1="21.3375" x2="18.3775" y1="12.232" y2="6.44605">
...
function Group2() {
  return (
    <div className="absolute contents left-[47.37%] right-[13.16%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[47.37%] not-italic right-[13.16%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)] whitespace-pre">BTC</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents left-[15.79%] right-[15.79%] top-[4.74px]">
      <Group1 />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[44.74%] not-italic right-[15.79%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)] whitespace-pre">ETH</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[42.11%] right-[5.26%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[42.11%] not-italic right-[5.26%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)] whitespace-pre">USDT</p>
    </div>
  );
}
  ...
  return (
    <div className="absolute contents inset-0" data-name="img_blockchain_usdt">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 11 11">
        <path d={svgPaths.p32f47d00} fill="var(--fill-0, #27A17C)" id="æ¤­åå½¢" />
      </svg>
...
function Group7() {
  return (
    <div className="absolute contents left-[47.37%] right-[15.79%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[47.37%] not-italic right-[15.79%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)] whitespace-pre">XRP</p>
    </div>
  );
}
...
export default function List() {
  return (
    <div className="content-center flex flex-wrap gap-[16px] items-center relative size-full" data-name="List">
      <Item />
      <Item1 />
      <Item2 />
      <Item3 />
