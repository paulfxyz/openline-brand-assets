  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
        <g id="Img">
          <path d={svgPaths.p265aae00} fill="var(--fill-0, black)" id="Vector" opacity="0.07" />
          <path d={svgPaths.p1e9ee00} fill="var(--fill-0, #006FCF)" id="Vector_2" />
          <path d={svgPaths.p149a8000} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p24a0940} fill="var(--fill-0, #006FCF)" id="Vector_4" />
          <path d={svgPaths.p1de50680} fill="var(--fill-0, #006FCF)" id="Vector_5" />
          <path d={svgPaths.p22970280} fill="var(--fill-0, white)" id="Vector_6" />
          <path d={svgPaths.pb495a00} fill="var(--fill-0, #006FCF)" id="Vector_7" />
          <path d={svgPaths.p1044e900} fill="var(--fill-0, #006FCF)" id="Vector_8" />
        </g>
      </svg>
    </div>
  );
...
function Img3() {
  return (
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
        <g id="Img">
          <path d={svgPaths.p5451880} fill="var(--fill-0, #005B9A)" id="Vector" />
          <path d={svgPaths.p115b7af2} fill="var(--fill-0, #E9292D)" id="Vector_2" />
          <path d={svgPaths.p14f76a80} fill="var(--fill-0, #0E73B9)" id="Vector_3" />
          <path d={svgPaths.p2e09b000} fill="var(--fill-0, #059DA4)" id="Vector_4" />
          <path d={svgPaths.p38409f00} fill="var(--fill-0, white)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Img6() {
  return (
    <div className="h-[24px] relative shrink-0 w-[38px]" data-name="Img">
      <div className="absolute bottom-0 left-[0.67%] right-[0.67%] top-0" data-name="Vector">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 38 24">
