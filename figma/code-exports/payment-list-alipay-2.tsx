import svgPaths from "./svg-dcei6jtlm0";
...
function Img16({ children }: React.PropsWithChildren<{}>) {
  return (
    <Wrapper>
      <g id="Img">{children}</g>
    </Wrapper>
  ...
  return (
    <Wrapper>
      <g id="Img">
        ...
        <path d={svgPaths.p8dd84c0} fill="url(#paint0_linear_8010_989)" id="Vector_4" />
        <path d={svgPaths.p8dd84c0} fill="url(#paint1_linear_8010_989)" id="Vector_5" opacity="0.65" />
      ...
      <defs>
        <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_8010_989" x1="21.6565" x2="19.6315" y1="12.275" y2="9.10405">
        ...
        <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_8010_989" x1="21.3375" x2="18.3775" y1="12.232" y2="6.44605">
...
function Group2() {
  return (
    <div className="absolute contents left-[47.37%] right-[13.16%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[47.37%] not-italic right-[13.16%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)]">BTC</p>
    </div>
  );
}
...
function Group5() {
  return (
    <div className="absolute contents left-[15.79%] right-[15.79%] top-[4.74px]">
      <Group1 />
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[44.74%] not-italic right-[15.79%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)]">ETH</p>
    </div>
  );
}
...
function Group6() {
  return (
    <div className="absolute contents left-[42.11%] right-[5.26%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[42.11%] not-italic right-[5.26%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)]">USDT</p>
    </div>
  );
}
...
function Group7() {
  return (
    <div className="absolute contents left-[47.37%] right-[15.79%] top-1/2 translate-y-[-50%]">
      <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[47.37%] not-italic right-[15.79%] text-[#5b5b5b] text-[7px] text-nowrap top-[calc(50%-4px)]">XRP</p>
    </div>
  );
}
